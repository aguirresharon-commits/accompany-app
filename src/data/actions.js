...
const taskList = [
  ...
  { id: 'mente-baja-2', text: 'Cerrar los ojos durante 30 segundos', level: 'baja', section: 'mente', duration: 0.5, canReduce: false },
  { id: 'mente-baja-3', text: 'Nombrar cómo te sentís ahora', level: 'baja', section: 'mente', duration: 0.5, canReduce: false },
  { id: 'mente-media-1', text: 'Pensar una intención para hoy', level: 'media', section: 'mente', duration: 2, canReduce: false },
  { id: 'mente-media-2', text: 'Escribir una frase sobre lo que pensás', level: 'media', section: 'mente', duration: 3, canReduce: false },
  { id: 'mente-media-3', text: 'Leer una página de algo que te interese', level: 'media', section: 'mente', duration: 5, canReduce: false },
  { id: 'mente-alta-1', text: 'Ordenar una idea que tengas en mente', level: 'alta', section: 'mente', duration: 10, canReduce: false },
  { id: 'mente-alta-2', text: 'Planear algo simple que quieras hacer', level: 'alta', section: 'mente', duration: 10, canReduce: false },
  { id: 'mente-alta-3', text: 'Escribir y soltar una preocupación', level: 'alta', section: 'mente', duration: 10, canReduce: false },
  // CUERPO
  { id: 'cuerpo-baja-1', text: 'Estirarte durante 30 segundos', level: 'baja', section: 'cuerpo', duration: 0.5, canReduce: false },
  { id: 'cuerpo-baja-2', text: 'Abrir una ventana y respirar aire fresco', level: 'baja', section: 'cuerpo', duration: 0.5, canReduce: false },
  { id: 'cuerpo-baja-3', text: 'Tomar un vaso de agua', level: 'baja', section: 'cuerpo', duration: 1, canReduce: false },
  { id: 'cuerpo-media-1', text: 'Caminar durante 3 minutos', level: 'media', section: 'cuerpo', duration: 3, canReduce: false },
  ...
  { id: 'cuerpo-alta-1', text: 'Caminar durante 10 minutos', level: 'alta', section: 'cuerpo', duration: 10, canReduce: false },
  { id: 'cuerpo-alta-2', text: 'Hacer cardio o saltar la soga 5–10 minutos', level: 'alta', section: 'cuerpo', duration: 8, canReduce: false },
  { id: 'cuerpo-alta-3', text: 'Ordenar algo físico a tu alrededor', level: 'alta', section: 'cuerpo', duration: 10, canReduce: false },
  // BIENESTAR
  { id: 'bienestar-baja-1', text: 'Cambiar de posición por un momento', level: 'baja', section: 'bienestar', duration: 0.5, canReduce: false },
  { id: 'bienestar-baja-2', text: 'Mirar algo que te calme', level: 'baja', section: 'bienestar', duration: 1, canReduce: false },
  { id: 'bienestar-baja-3', text: 'Encender o buscar luz natural', level: 'baja', section: 'bienestar', duration: 0.5, canReduce: false },
  { id: 'bienestar-media-1', text: 'Preparar algo caliente para tomar', level: 'media', section: 'bienestar', duration: 5, canReduce: false },
  { id: 'bienestar-media-2', text: 'Tomar una ducha corta', level: 'media', section: 'bienestar', duration: 10, canReduce: false },
  { id: 'bienestar-media-3', text: 'Ordenar un espacio pequeño', level: 'media', section: 'bienestar', duration: 5, canReduce: false },
  { id: 'bienestar-alta-1', text: 'Mejorar o acomodar un espacio', level: 'alta', section: 'bienestar', duration: 15, canReduce: false },
  { id: 'bienestar-alta-2', text: 'Preparar algo simple para vos', level: 'alta', section: 'bienestar', duration: 10, canReduce: false },
  { id: 'bienestar-alta-3', text: 'Crear un pequeño ritual', level: 'alta', section: 'bienestar', duration: 10, canReduce: false },
  // PRODUCTIVIDAD
  { id: 'productividad-baja-1', text: 'Abrir una app o archivo pendiente', level: 'baja', section: 'productividad', duration: 0.5, canReduce: false },
  { id: 'productividad-baja-2', text: 'Leer un mensaje que tengas pendiente', level: 'baja', section: 'productividad', duration: 1, canReduce: false },
  { id: 'productividad-baja-3', text: 'Anotar una tarea que tengas en mente', level: 'baja', section: 'productividad', duration: 1, canReduce: false },
